...
def main():
    print("main function for multi index search")
...
# uv run -m app.rag.Multi_Index_search
# this file demonstrates how to use the Retriever class to search across multiple indexes#
# (in this case, a BM25 index and a vector index) and combine their results using Reciprocal Rank Fusion (RRF)
